    ...
    <nav className="bg-white shadow-sm sticky top-0 z-50">
        ...
        <div className="flex justify-between h-24 md:h-20 flex-col md:flex-row">
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden sm:ml-6 sm:flex sm:items-center">
              {isLoggedIn ? (
                <Link href="/profile" className="flex items-center text-gray-700 hover:text-primary font-medium p-2 rounded-md">
      ...
      <div className={`${isOpen ? 'block' : 'hidden'} sm:hidden`} id="mobile-menu">
        <div className="pt-2 pb-3 space-y-1">
          ...
          <Link href="/#categories" className="block pl-3 pr-4 py-2 border-l-4 border-transparent text-base font-medium text-gray-700 hover:bg-gray-50 hover:border-gray-300">Categories</Link>
          <Link href="/#vendors" className="block pl-3 pr-4 py-2 border-l-4 border-transparent text-base font-medium text-gray-700 hover:bg-gray-50 hover:border-gray-300">Vendors</Link>
          {isLoggedIn ? (
            <Link href="/profile" className="block pl-3 pr-4 py-2 border-l-4 border-transparent text-base font-medium text-gray-700 hover:bg-gray-50 hover:border-gray-300">Profile</Link>
          ) : (
            <Link href="/login" className="block pl-3 pr-4 py-2 border-l-4 border-transparent text-base font-medium text-gray-700 hover:bg-gray-50 hover:border-gray-300">Login</Link>
          )}
        </div>
      </div>
    </nav>
